...
function ip_pool_sql(params, attrs, cb) {
    //With this woodoo query what we try is to reuse this user's old IP should it be still available,
...
function sql_account(params, attrs, cb) {
